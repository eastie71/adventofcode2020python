...
# This took nearly 1 minute to return the result
print(f"2020 Question 15B: 30000000th value from game is = {get_result_for_number_game_for_turn(puzzle_numbers, 30000000)}")